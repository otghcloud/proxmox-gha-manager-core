...
@section('page-sub-content')
	<div class="card-body">
		<h3 class="card-title">Toggles</h3>
	...
	<div class="card-body">
		<h3 class="card-title">Configuration export</h3>
	...
	<div class="card-body p-0">
		<h3 class="card-title p-3 pb-0">Destructive actions</h3>
	...
	<div class="card-body">
		<h3 class="card-title">Effective pool limits</h3>
